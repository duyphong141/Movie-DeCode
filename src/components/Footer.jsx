...
export default function Footer() {
    ...
    // lấy logo rạp chiếu (bóc tách từ mảng lớn)
    const {heThongRapChieu} = useSelector(state => state.quanLyRapReducer);

    const arrLogoHeThongRap = _.map(heThongRapChieu, (heThongRap) => _.pick(heThongRap, ['logo']));


    return (
        <footer className="py-6 dark:bg-gray-800 dark:text-gray-50 bg-gray-500 text-white">
                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <div className='grid grid-cols-2' >
                            {arrLogoHeThongRap.map((item, index) => {
